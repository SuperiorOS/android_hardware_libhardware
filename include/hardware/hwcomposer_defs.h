...
enum {
    ...
    HWC_DISPLAY_EXTERNAL_2  = 3,
    HWC_DISPLAY_EXTERNAL_3  = 4,
    HWC_DISPLAY_EXTERNAL_4  = 5,

    HWC_DISPLAY_BUILTIN_2   = 6,
    HWC_DISPLAY_BUILTIN_3   = 7,
    HWC_DISPLAY_BUILTIN_4   = 8,

    HWC_DISPLAY_VIRTUAL     = 9,

    HWC_NUM_PHYSICAL_DISPLAY_TYPES = 9,
    HWC_NUM_DISPLAY_TYPES          = 10,
#else
